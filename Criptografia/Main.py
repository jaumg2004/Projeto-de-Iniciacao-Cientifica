...
h1_bchamming = np.random.rayleigh(10.0, nBits)
h2_bchamming = np.random.rayleigh(10.0, nBits)

h1_golay = np.random.rayleigh(10.0, 24)
h2_golay = np.random.rayleigh(10.0, 24)
